# Generated by Django 4.1.5 on 2023-03-19 13:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('poster', models.ImageField(upload_to='movie/', verbose_name='Изображение')),
                ...
                ('directors', models.ManyToManyField(related_name='film_directors', to='movies.actor', verbose_name='Режисеры')),
